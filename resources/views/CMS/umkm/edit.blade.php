...
<div class="card">
    ...
    <div class="card-header">
        <h3 class="card-title">Edit Data UMKM</h3>
    </div>

    <form
        action="{{ url('/admin/umkm/update/' . $umkm->id) }}"
        method="POST"
    ...
    >
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="nama_pelaku">Nama Pelaku UMKM</label>
                ...
                <input
                    ...
                    id="nama_pelaku"
                    class="form-control"
                    value="{{ old('nama_pelaku', $umkm->nama_pelaku) }}"
                    placeholder="Contoh: Siti Aminah"
                >

                <small class="form-text text-muted">
                    Nama pemilik atau pelaku usaha.
                </small>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="harga_mulai"
                    class="form-control"
                    value="{{ old('harga_mulai', $umkm->harga_mulai) }}"
                    min="0"
                >
            </div>
