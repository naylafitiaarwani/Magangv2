...
@section('title page', 'Edit Budaya')

@section('content')

<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edit Data Budaya</h3>
    </div>

    <form
        action="{{ url('/admin/budaya/update/' . $budaya->id) }}"
        method="POST"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="lokasi"
                    class="form-control"
                    value="{{ old('lokasi', $budaya->lokasi) }}"
                >
            </div>
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    rows="5"
                    class="form-control"
                >{{ old('deskripsi', $budaya->deskripsi) }}</textarea>
            </div>
