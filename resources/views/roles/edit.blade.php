    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-info">
          <form action="{{url('/roles/update').'/'.$data->id}}" method="post" class="form-horizontal">
            @csrf
            <div class="card-body">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input" id={{ 'view_' . $menu->id }}
                                          name={{ 'view_' . $menu->id }}
                                          {{ $data->remapPriviledge['view_' . $menu->id] == 1 ? 'checked' : '' }}>
                              ...
                              <td>
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input" id={{ 'add_' . $menu->id }}
                                          name={{ 'add_' . $menu->id }}
                                          {{ $data->remapPriviledge['add_' . $menu->id] == 1 ? 'checked' : '' }}>
                              ...
                              <td>
                                  ...
                                  <input type="checkbox" class="custom-control-input" id={{ 'edit_' . $menu->id }}
                                      name={{ 'edit_' . $menu->id }}
                                      {{ $data->remapPriviledge['edit_' . $menu->id] == 1 ? 'checked' : '' }}>
                              ...
                              <td>
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input" id={{ 'delete_' . $menu->id }}
                                          ...
                                          {{ $data->remapPriviledge['delete_' . $menu->id] == 1 ? 'checked' : '' }}>
                              ...
                              <td>
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input" id={{ 'other_' . $menu->id }}
                                          name={{ 'other_' . $menu->id }}
                                          {{ $data->remapPriviledge['other_' . $menu->id] == 1 ? 'checked' : '' }}>
